		...
		<p>
			...
			<span></span>
	    			...
	    			<div id="placeholder"style="border:1px solid black; min-height:200px;">
    					...
    					<div class="col s5 offset-s5" style="margin-top:10%">
		    				<div class="preloader-wrapper big active valing">
